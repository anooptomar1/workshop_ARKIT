//
//  ARKITViewCourirExercicesController.swift
//  arkitDev
//
...
class ARKITViewCourirExercicesController: UIViewController, ARSCNViewDelegate {
    
    @IBOutlet weak var CourirSceneView: ARSCNView!
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        // Set the view's delegate
        CourirSceneView.delegate = self
        
        // Show statistics such as fps and timing information
        CourirSceneView.showsStatistics = true
        
        // Create a new scene
        let scene = SCNScene()
        
        // Set the scene to the view
        CourirSceneView.scene = scene
    }
    ...
    func addCoachBoard() -> SCNNode {
        ...
        // Import my 3D Object
        let coachBoardScene = SCNScene(named: "art.scnassets/Mec_courir/Coach_Mec_Courir/Coach_Mec_Courir.dae")!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        CourirSceneView.session.run(configuration)
    }
